---
title: Sử dụng ký pháp BEM trong CSS
author: Hung Tan Nguyen
tags:
  - css
categories: []
coverImage: 'https://cdn-images-1.medium.com/max/800/1*bQLArQAfcohZ5E81z8gcHg.jpeg'
sourceUrl: 'https://int3ractive.com/2015/12/ky-phap-bem-trong-css.html'
date: 2018-05-20 16:05:00
slug: /su-dung-ky-phap-bem-trong-css
---
...
<a class="btn btn--big btn--orange" href="http://int3ractive.com">
  <span class="btn__price"
    ><i class="icon icon--dollar-sign btn__icon"></i>9.99</span
  >
  <span class="btn__text">Subscribe</span>
</a>
```
